...
<div class="my-10 mx-auto max-w-[320px] rounded-[2.5rem] border-[3px] border-gray-900 overflow-hidden shadow-2xl bg-white" style="box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25);">
  <!-- 手机外框 -->
